...
3. [Системные требования](#3) <br>
    3.1 [Функциональные требования](#3.1) <br>
        3.1.1 [Основные функции](#3.1.1) <br>
            ...
            3.1.1.3 [Создание мероприятия](#3.1.1.3) <br>
            3.1.1.4 [Изменение мероприятия](#3.1.1.4) <br>
            3.1.1.5 [Удаление мероприятия](#3.1.1.5) <br>
...
В данном документе будут описаны функциональные и нефункциональные требования к web-приложению "My Events". <br>
...
Значительное развитие информационных технологий затронуло все сферы жизнедеятельности человека, поэтому в XXI веке людям гораздо проще договориться о личной встрече в Интернете, назначив дату, место и время. Вследствие этого разрабатываемое приложение будет востребовано, так как оно облегчит пользователям процесс создания или поиска мероприятия. 
...
Приложение будет написано на языке JavaScript.<br>
Для написания серверной части будет использоваться платформа Node.js в связке с фреймворком Express. В качестве системы управления базами данных будет задействована PostgreSQL, а в качестве ORM для реляционной базы данных - Sequelize. В базе данных должны храниться логин (почта) и пароль каждого зарегистрированного пользователя, информация о мероприятиях и приглашениях. Пароль должен обязательно храниться в захешированном виде, для этого будет использована адаптивная криптографическая хеш-функция формирования ключа bcrypt. <br>
Для написания клиентской части будет использована библиотека React в связке с библиотекой React-компонентов React-Bootstrap, библиотека для поддержки HTTP-запросов Axios, модуль React-router-dom для маршрутизации, библиотека для управления фронтенд-состоянием приложения MobX.

Для авторизации пользователя будет использован токен доступа JWT.
#### 2.2 Интерфейс пользователя <a name="2.2"></a>
Окно входа в приложение.<br>
  <br>
![](https://github.com/Varyasha/Tritpo/raw/main/documentation/mockups/Auth.png)<br>
Окно регистрации нового пользователя.<br>
  <br>
...
Если же пользователь уже зарегистрирован, то для авторизации он должен нажать на подсвечивающуюся синюю надпись "Войдите!" на странице с регистрацией либо же на кнопку "Авторизация" справа вверху страницы, после чего откроется страница авторизации, где пользователю будет преложено ввести свои почту и пароль.
###### 3.1.1.3 Создание мероприятия <a name="3.1.1.3"></a>
...
###### 3.1.1.4 Изменение мероприятия <a name="3.1.1.4"></a>
Для изменения мероприятия в личном кабинете пользователя необходимо выбрать вкладку "Мои мероприятия" и на открывшейся странице сбоку справа от названия мероприятия, которое пользователь хочет изменить, нажать на кнопку "Изменить".
###### 3.1.1.5 Удаление мероприятия <a name="3.1.1.5"></a>
Производится аналогично изменению, только вместь кнопки "Изменить" необходимо нажать на кнопку "Удалить", а затем во всплывшем окне подтвердить удаление.
...
3) Цвета фона и текста должны быть контрастными, чтобы обеспечить пользователю комфортное использование сайта.
