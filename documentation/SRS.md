...
Для написания серверной части будет использоваться платформа Node.js в связке с фреймворком Express. В качестве системы управления базами данных будет задействована PostgreSQL, а в качестве ORM для реляционной базы данных - Sequelize.<br>
